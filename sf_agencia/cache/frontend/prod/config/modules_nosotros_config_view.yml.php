...
$response = $this->context->getResponse();
  ...
  $response->addMeta('title', 'Agencia de Festejos Inversiones SAJ c.a', false, false);
  $response->addMeta('description', 'Agencia de Festejos Inversiones', false, false);
  $response->addMeta('keywords', 'agencia festejos inversiones', false, false);
